...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-ddbe800a');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-ddbe800a');}
...
var brandEl=document.querySelector('.rl-brand-ddbe800a');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
